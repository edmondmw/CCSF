...
//Objective: Convert temperature from Celsius to Fahrenheit or
// vice versa.
package com.example.edmondwang.tempconversionhw3;
...
public class TemperatureConversion extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        tv.setText(getResources().getString(R.string.cToFPrompt));
        ...
        et.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            {
                //When we hit enter, we do the same as hitting the
                //convert button
